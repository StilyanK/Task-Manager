...
void routesChat(Router router) {
  ...
  router
      .serve(RoutesChat.messageUpdate, method: 'POST')
      .listen((req) => CChat(req).messageUpdate());
  router
      .serve(RoutesChat.messageWrite, method: 'POST')
      .listen((req) => CChat(req).messageWrite());
  router
